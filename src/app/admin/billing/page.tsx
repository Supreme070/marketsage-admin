...
import { UsageBreakdownDashboard } from "@/components/admin/UsageBreakdownDashboard";
import { CostAllocationDashboard } from "@/components/admin/CostAllocationDashboard";
      ...
      <div className="p-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
          <TabsList className="grid w-full grid-cols-6 lg:w-auto">
            ...
            <TabsTrigger value="cost-allocation" className="flex items-center gap-2">
          ...
          <TabsContent value="usage" className="space-y-4">
            <UsageBreakdownDashboard />
          </TabsContent>

          <TabsContent value="cost-allocation" className="space-y-4">
