...
export default function AdminCampaignsPage() {
  ...
  // Real API call to fetch campaigns from backend
  useEffect(() => {
    const fetchCampaigns = async () => {
      ...
      try {
        ...
        const response = await fetch(`${backendUrl}/admin/campaigns?${queryParams}`, {
          headers: {
    ...
    fetchCampaigns();
  }, [searchTerm, typeFilter, statusFilter, currentPage, session]);
